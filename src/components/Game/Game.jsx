...
function Game(props) {
  ...
  function colorEntries() {
    for (let i = 0; i <= currentInputRow; i++) {
      for (let e = 0; e < 5; e++) {
        if (greenEntries[i][e]) {
          document.getElementById(i + " " + e).style.backgroundColor = "green";
        } else if (yellowEntries[i][e]) {
          document.getElementById(i + " " + e).style.backgroundColor = "yellow";
        } else {
  ...
  function newWord () {
    let tempArray1 = greenEntries;
    for (let i = 0; i < 6; i++) {
      for (let e = 0; e < 5; e++) {
        tempArray1[i][e] = false;
      }
    }
    let tempArray2 = yellowEntries;
    for (let i = 0; i < 6; i++) {
      for (let e = 0; e < 5; e++) {
        tempArray2[i][e] = false;
      }
    }
    let tempArray3 = entries;
    for (let i = 0; i < 6; i++) {
      for (let e = 0; e < 5; e++) {
        tempArray3[i][e] = "";
      }
    ...
    currentInputRow = 0;
    setGreenEntries([...tempArray1]);
    setYellowEntries([...tempArray2]);
  ...
  function submitGuess() {
    ...
    setGreenEntries([...tempGreenEntries]);
